...
namespace PupBnB.Areas.Identity.Pages.Account
{
    ...
    public class RegisterModel : PageModel
    {
        ...
        private readonly IProfileImageRepository _profileImage;
        ...
        public async Task<IActionResult> OnPostAsync(IFormFile file, string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                ApplicationUser user = _registerService.GetUser(Input.Email, Input.FullName, file.FileName);
                IdentityResult result = await _registerService.CreateApplicationUserAsync(_userManager, user, Input.Password);
